...
function initStackedBarReal() {
    ...
    // CORES GRADIENTES POR FORNECEDOR
    const cores = {
        'Nivea 🚨': '#ef4444',
        'Cargill': '#f97316',
        'Bic': '#eab308',
...
function updateActiveNav() {
    const sections = ['visao-geral', 'problema', 'analise', 'solucoes', 'projecoes', 'foco-nivea', 'top-contas'];
